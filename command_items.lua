...
hoverbot.register_command("page_1","Run Codepage1")
hoverbot.register_command("page_2","Run Codepage2")
hoverbot.register_command("page_3","Run Codepage3")
hoverbot.register_command("page_4","Run Codepage4")
hoverbot.register_command("page_5","Run Codepage5")
...
hoverbot.register_command("upload","Send item to DigiBank server")
hoverbot.register_command("download","Retrieve item from DigiBank server")
